            ...
            connection.onmessage = function (message) {
                ...
                if (msg.type == 'join') {
                    ...
                    console.log('confirm ACK: ' + msg.game_id + ' with ' + msg.owner_id + ' against ' + msg.opponent_id
                        + ' with ' + msg.color);
                    if (msg.owner_id == uid) {
                        window.location.href = '/openxum-html5/index.php/games/play_Yinsh/game_id:' + msg.game_id
                            + '/owner_id:' + msg.owner_id + '/opponent_id:' + msg.opponent_id + '/color:' + msg.color;
                    } else {
                        window.location.href = '/openxum-html5/index.php/games/play_Yinsh/game_id:' + msg.game_id
                            + '/owner_id:' + msg.opponent_id + '/opponent_id:' + msg.owner_id + '/color:'
                            + (msg.color == 'black' ? 'white' : 'black');
                    }
                }
            };
